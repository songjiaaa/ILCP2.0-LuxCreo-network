#include "ws2812b.h"
u8 ws12b_on = 0xFF;         //灯带开关  默认开

u16 led_data_buf[1000];  //灯珠颜色缓存

//红橙黄绿青蓝紫 白黑
u8 red[] = {100,0,0};        //红
u8 orange[] = {150,60,0};
u8 yellow[] = {60,60,0};    //黄 255 255
u8 green[] = {0,30,0};       //绿
u8 cyan[] = {0,255,255};     //青
u8 blue[] = {0,0,255};       //蓝
u8 purple[] = {128,0,128};   //紫
...
void rgb_warning_show(u8 color[])
{
	...
	{
		led_single_show(black,RGB_LED_NUM);   //灭
	}
...
//进度灯显示
void light_progress_display(void)
{
