...
#define CODE_UtoG_BASE (0xF00000)  //以15M内存地址
//GBK转unicode码表
//#define CODE_GtoU_BASE (0xC000)
#define CODE_GtoU_BASE (0xF0C000)
...
u16 GBKtoUNICODE(u16 GBKCode)
{
	...
	W25QXX_Read(buff,CODE_GtoU_BASE + unicode,2) ; //读取码表
...
u16 UNICODEtoGBK(u16 unicode)  //用二分查找算法
{
	...
	W25QXX_Read(temp,offset*2+CODE_UtoG_BASE,2);//得到GBK码   
	res=temp[0];
	res<<=8;
	res+=temp[1];   
	return res ; //返回找到的编码
