...
typedef struct
{
	u8  mode;       //固化模式 0 空闲  1 固话中 2 固话中暂停  
	u8  step;       //当前步数
	u32 cure_tick;  
	u32 step_cnt_time;   //每步计数时间
	s16 exp_temp;   //期望温度
	u16 r_time;     //剩余时间
	u16 total_time; //总时间
}curing_pro;
...
#define DESTIN_CURE_FILE  "1:Cure.txt"     
#define SOURCE_CURE_FILE  "2:/ILCP_IMPORT_FILE/Cure.txt"
